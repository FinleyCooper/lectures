...
\end{remark}
Let's see an application of the momentum equation. Consider a $ 90^{\text o} $ bent pipe with a flow $ U $. What is the force exerted by flow on the pipe for a steady flow without gravity? 

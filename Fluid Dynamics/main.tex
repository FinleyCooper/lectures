...
Take a tank full of fluid with a small hole at the bottom. The water height has height $ h $ and the fluid exists the tank with speed $ u $. We assume that the size of the hole is small enough so the flow is steady. At the top of the tank, the pressure is atmospherical pressure and the exist it is the same. Taking a streamline from the top on the tank to the exist we'll use the steady flow Bernoulli equation. We have gravity so $ \chi = - \rho gh $. At the top we have $ H_1 $ and at the bottom we have $ H_2 $, from Bernoulli, $ H_1=H_2 $,
\[

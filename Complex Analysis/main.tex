...
\begin{theorem}
	(Cauchy for simply connected domains) If $ U\subseteq \C $ is a simply connected sdomain and $ f:U\to \C $ is holomorphic then
	\[
	  \int_\gamma =0
	\]
	for all closed piecewise-$ C^1 $ curves $ \gamma $ in $ U $.
\end{theorem}
First let's prove a definition.
\begin{definition}
...
\begin{proposition}
  If $ U $ is a domain amkd $ \psi,\phi $ are homotopic piecewise-$ C^1 $ paths and if $ f:U\to \C $ is holomorphic, then
  \[
    \int_\phi f = \int_\psi.
  \]
\end{proposition}

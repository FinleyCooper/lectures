...
\begin{example}
  ...
  \end{enumerate}
\end{example}
Recall that if $ U $ is a domain $ S\subseteq U $ dinite and $ f:U\to\C $ continuous and holomorphic on $ U\setminus S $, then $ f $ is holomorphic on $ U $ by Morera's theorem. But what happens if $ f $ is not continuous at $ S $?
\begin{proposition}

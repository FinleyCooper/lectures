...
\subsubspace{The product topology}
...
\]
is continuous if and only if $ \pi_X\circ f:(Z,T_Z)\to (X,T_X) $ and $ \pi_Y\circ f:(Z,T_Z)\to (Y,T_Y) $ are continuous. Equivalently, if $ f $ is componentwise continuous.
